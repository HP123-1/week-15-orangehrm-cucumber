package com.orangelive.demo.opensource.propertyreader;
...
public class PropertyReader {
    ...
    */
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/src/test/java/com/orangelive/demo/opensource/resources/propertiesfile/config.properties");
